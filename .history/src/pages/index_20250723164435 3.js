...
Api.js:67
 PUT https://around-api.en.tripleten-services.com/v1/cards/undefined/likes 400 (Bad Request)
addCardLike	@	Api.js:67
handleLikeClick	@	index.js:274
(anonymous)	@	Card.js:38
  ...
  if (isLiked) {
    api
      ...
      .then((updatedCard) => {
        card.setLikeStatus(updatedCard.isLiked); // ✅ use isLiked directly
      })
      .catch((err) => console.error(err));
  } else {
    api
