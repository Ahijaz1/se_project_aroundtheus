...
// Debug the URL input field
console.log("=== DEBUGGING URL INPUT ===");
const urlInput = document.getElementById("card-url-input");
if (urlInput) {
  console.log("URL input found:", urlInput);
  console.log("Is disabled?", urlInput.disabled);
  console.log("Has readonly?", urlInput.readOnly);
  console.log("Input type:", urlInput.type);
  console.log("Input value:", urlInput.value);
} else {
...
urlInput.addEventListener("blur", () => console.log("URL input lost focus!"));
urlInput.addEventListener("input", () =>
  console.log("URL input changed:", urlInput.value)
);

// Check if there are any overlapping elements
console.log("Input position:", urlInput.getBoundingClientRect());
console.log(
  "Input computed style display:",
  getComputedStyle(urlInput).display
);
console.log(
  "Input computed style visibility:",
  getComputedStyle(urlInput).visibility
);
