...
const profileDescriptionInput =
  profileEditModal.querySelector(".modal__form").elements.description;
...
// Initial data fetching and rendering cards
...
// Profile edit popup with API update
...
const deleteCardPopup = new PopupWithSubmit("#delete-card-modal", () => {
  ...
  if (!cardToDelete.isLocal && cardToDelete.cardId) {
    api
...
// Card creation helpers and handlers
...
function handleLikeClick(card) {
  if (card.isLocal) {
    card.setLikeStatus(!card.isLiked);
    return;
  }
