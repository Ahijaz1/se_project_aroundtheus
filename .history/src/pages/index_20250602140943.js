...
api
  .getUserInfo()
  .then((userData) => console.log("getUserInfo success:", userData))
  .catch((err) => console.log("getUserInfo error:", err));

api
  .getInitialCards()
  .then((cardsData) => console.log("getInitialCards success:", cardsData))
  .catch((err) => console.log("getInitialCards error:", err));

Promise.all([api.getUserInfo(), api.getInitialCards()])
  .then(([userData, cardsData]) => {
    currentUserId = userData._id; // Save user ID here
...
function createCard(cardData, userId) {
  const isLiked = Array.isArray(cardData.likes)
