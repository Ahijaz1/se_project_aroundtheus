...
const handleAddCardSubmit = document.querySelector(
...
const profileImageEditButton = document.querySelector(".profile__edit-button");
...
const newCardPopup = new PopupWithForm("#add-card-modal", (inputValues) => {
  api
    ...
    .finally(() => {
      handleAddCardSubmit.textContent = "Save";
    });
});
...
handleAddCardSubmit.addEventListener("click", () => {
